...
d3.json(file, function (json) {
  ...
  collapse(root.children[0].children[3]);
  collapse(root.children[0].children[2].children[1]);
  collapse(root.children[0].children[0].children[2]);  

  collapse(root.children[1].children[1]);
  collapse(root.children[1].children[2]);

  root.children[2].children.forEach(collapse);
